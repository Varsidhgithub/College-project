...
export function ExamModule() {
    ...
    const showSuccess = () => {
        toast.current.show({ severity: 'success', summary: 'Submitted', detail: 'Exam Details Submitted', life: 3000 });
    };
    return (
        <div className="grid">
                ...
                <div className='card'>
                    ...
                    <div className="p-fluid formgrid grid">
                        ...
                        <div className="field col-12 md:col-7">
                            <label htmlFor="state">Upload Exam Paper </label>
                    ...
                    <div className="p-fluid formgrid grid">
                        ...
                        <div className="field col-12 md:col-7">
                            <label htmlFor="state">Upload Exam Timetable </label>
                            <FileUpload name="demo[]" url="./upload.php" onUpload={onUpload} multiple accept="images/*" maxFileSize={2000000} />
