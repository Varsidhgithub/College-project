...
export const AddFaculty = () => {
  ...
  return (
    ...
    <div >
      <div className='card'>
        <span><Link to="/admin/Facultys">Faculty</Link> / Add faculty</span>
        ...
        <div className="col-8">
          <div className="card">
            ...
            <div className="p-fluid formgrid grid">
              ...
              <div className="field col-12 md:col-6">
                <label htmlFor="mobile">Faculty Mobile no.</label>
                <InputText id="mobile" type="number" />
              </div>
              <div className="field col-12 md:col-6">
                <label htmlFor="standard">Standard</label>
                <Dropdown id="standard" value={dropdownItems1} onChange={(e) => setDropdownItem(e.value)} options={dropdownItems1} optionLabel="name" placeholder="Select One"></Dropdown>
              </div>

              <div className="field col-12">
                <label htmlFor="address">Address</label>
                <InputTextarea id="address" rows="4" type="text" />
              </div>
              <div className="field col-12 md:col-6">
              ...
              <div className="field col-12 md:col-3">
                ...
                <InputText id="pincode" type="number" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className='col-4'>
          <div className='card card-user'>
            ...
            <div className='backbtn'>
              <Link to="/admin/Facultys"><Button className="submitbtn mr-5" label="Back" icon="pi pi-arrow-left" s /></Link>
              <Link to="/admin/Facultys"><Button className="submitbtn" label="Submit" icon="pi pi-check" /></Link>
            </div>
